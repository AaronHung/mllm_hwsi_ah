...
from timm.layers import DropPath, Mlp, PatchEmbed, resample_abs_pos_embed, use_fused_attn
from torch.jit import Final

try:
    from timm.layers import LayerType
except ImportError:
    # LayerType is not exported in some timm versions; this matches its intent.
